        ...
        <View style={styles.container}>
            ...
            <View style={styles.headerStyle}>
                ...
                <View style={{display:"flex", flexDirection:"row"}}>
                    <Text style={{color:"#2F3C7E"}}>Search </Text>
                </View>
            ...
            <ImageBackground style={{height:"90%", padding:20}} source={require("../assets/map.png")}>
            ...
            <View style={styles.bottomNavContainer}>
                ...
                <TouchableOpacity onPress={navigation.navigate("Search")} style={{borderColor:"red", padding:10, borderStyle:"solid", borderTopColor:"#EA1588",borderTopWidth:4}}>
