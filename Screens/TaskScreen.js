        ...
        <View style={styles.container}>
            ...
            <View style={styles.headerStyle}>
                ...
                <View style={{display:"flex", flexDirection:"row"}}>
                    <Text style={{color:"#2F3C7E"}}>Task </Text>
                </View>
            ...
            <View style={styles.bottomNavContainer}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate("Task")} style={{borderColor:"red", padding:10, borderStyle:"solid", borderTopColor:"#EA1588",borderTopWidth:4}}>
                <Image source={require("../assets/Task.png")}/>
                    <Text>Task</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>navigation.navigate("Settings")} style={{borderColor:"red", padding:10}}>
