        ...
        <View style={styles.container}>
            ...
            <View style={styles.headerStyle}>
                ...
                <View style={{display:"flex", flexDirection:"row"}}>
                    <Text style={{color:"#2F3C7E"}}>Giveaway</Text>
                </View>
            ...
            <TouchableOpacity style={{borderColor:"red", padding:10, borderStyle:"solid", borderTopColor:"#EA1588",borderTopWidth:4}} onPress={()=>navigation.navigate("Home")}>
